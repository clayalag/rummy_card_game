...
public class Card implements CardInterface, Comparable<Card> {
  ...
  final public static String blankimg_file = "blank.gif";
  final public static String backimg_file = "back.gif";
  final public static String blankimg_filepath = directory + blankimg_file;
  final public static String cardback_filepath = directory + backimg_file;
